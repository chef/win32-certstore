...
win32-certstore uses the FFI gem for programmatically loading dynamic libraries,
binding functions within them, and calling those functions from Ruby code.
You can read about FFI at its [project page](https://github.com/ffi/ffi)
also check the wiki at its [wiki page](https://github.com/ffi/ffi/wiki).
